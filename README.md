...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-unbalanced-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9883&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-unbalanced-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-unbalanced` can be installed with:

```
conda install r-unbalanced
```

It is possible to list all of the versions of `r-unbalanced` available on your platform with:
